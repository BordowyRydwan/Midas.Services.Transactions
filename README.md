# Transaction Service
A microservice which handles domain logic containing all types of transactions. Repo contains ASP.NET + EF Core solution with test suites. By default a database and the API are set to work in Docker containers.
